...
all_names = {
    "Adrian Davey"       : (["ade@openembedded.org"], "ade@unknown.openembedded.org"),
    ...
    "Alex Osborne"       : (["Alex Osborne"], "alex.osborne@unknown.openembedded.org"),
    ...
    "Andrew Wilcox"      : (["awilcox@openembedded.org"], "awilcox@unknown.openembedded.org"),
    ...
    "Jeroen Hoek"        : (["Jeroen Hoek"], "jeroen.hoek@unknown.openembedded.org"),
    ...
    "MIka Laitio"        : (["lamikr@openembedded.org"], "lamikr@unknown.openembedded.org"),
    "Mike Montour"       : (["mail@mmontour.net"], "mail@mmontour.net"),
    "Mike Westerhof"     : (["mwester@openembedded.org", "mwester@wraith"], "mwester@dls.net"),
    "Mustafa Yuecel"     : (["yuecelm@nslu2-linux.org", "yuecelm@openembedded.org"], "yuecelm@ee.ethz.ch"),
    "musti"              : (["musti@openembedded.org"], "musti@unknown.openembedded.org"),
    ...
    "Patrick Ohly"       : (["pohly@openembedded.org"], "pohly@unknown.openembedded.org"),
    ...
    "Peter Urbanec"      : (["peteru@openembedded.org"], "peteru@unknown.openembedded.org"),
    "Petr Stetiar"       : (["ynezz@true.cz", "PetrŠtetiar"], "ynezz@true.cz"),
    "Phil Blundell"      : (["pb@openembedded.org", "nexus.co.uk!pb", "(none)!pb", "uk[pb]!pb", "reciva.com!pb"], "pb@unknown.openembedded.org"),
    "Philip Balister"    : (["crofton@openembedded.org"], "philip@balister.org"),
    "Philippe De Swert"  : (["philippe@openembedded.org"], "philippe@unknown.openembedded.org"),
    ...
    "Rene Wagner"        : (["rw@openembedded.org", "dyndns.org!oe", "dyndns.org!reenoo"], "rw@unknown.openembedded.org"),
