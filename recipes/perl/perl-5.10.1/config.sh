...
# Package name      : perl5
# Source directory  : .
# Configuration time: Wed Feb  3 23:55:19 Local time zone must be set--see zic manual page 2010
# Configured by     : Open Embedded
# Target system     : linux neo 2.6.30.1-rsbac-hw #1 smp i686 unknown
...
cf_time='Wed Feb  3 23:55:19 Local time zone must be set--see zic manual page 2010'
charsize='1'
chgrp=''
chmod='chmod'
chown=''
...
exe_ext=''
expr='expr'
extensions='attrs B ByteLoader Cwd Data/Dumper Devel/DProf Devel/Peek Devel/PPPort Digest/MD5 Encode Fcntl File/Glob Filter/Util/Call I18N/Langinfo IO IPC/SysV List/Util MIME/Base64 Opcode PerlIO/encoding PerlIO/scalar PerlIO/via POSIX re SDBM_File Socket Storable Sys/Hostname Sys/Syslog threads Time/HiRes Unicode/Normalize XS/APItest XS/Typemap threads/shared Attribute/Handlers Errno Module/Pluggable Safe Test/Harness'
extern_C='extern'
extras=''
fflushNULL='define'
fflushall='undef'
...
installsitearch='@DESTDIR@/usr/local/lib/perl/5.10.1'
installsitebin='@DESTDIR@/usr/local/bin'
installsitehtml1dir=''
installsitehtml3dir=''
installsitelib='@DESTDIR@/usr/local/share/perl/5.10.1'
...
config_arg11='-Dotherlibdirs=/usr/lib/perl5/5.10.1'
