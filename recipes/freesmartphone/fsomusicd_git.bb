...
#gst-plugins-base - gst-plugin-volume gst-plugin-alsa gst-plugin-ogg gst-plugin-audioconvert
#gst-plugins-good - gst-plugin-flac gst-plugin-wavparse gst-plugin-souphttpsrc
#gst-plugins-bad  - gst-plugin-ivorbis gst-plugin-mms gst-plugin-modplug
#gst-plugins-ugly - gst-plugin-mad gst-plugin-sid
