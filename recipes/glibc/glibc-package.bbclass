...
libc_baselibs_append_x86_64 = " /lib64/ld-linux-x86-64.so.2"
...
# Compatibility with third-party 64-bit software
do_install_append_x86_64 () {
	install -d ${D}/lib64
	ln -s ${base_libdir}/ld-linux-x86-64.so.2 ${D}/lib64/ld-linux-x86-64.so.2
}
