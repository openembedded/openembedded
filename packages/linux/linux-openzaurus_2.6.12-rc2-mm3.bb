...
SRC_URI = "ftp://ftp.kernel.org/pub/linux/kernel/v2.6/linux-2.6.11.tar.gz \
           ftp://ftp.kernel.org/pub/linux/kernel/v2.6/testing/patch-2.6.12-rc2.bz2;patch=1 \
           ftp://ftp.kernel.org/pub/linux/kernel/people/akpm/patches/2.6/2.6.12-rc2/2.6.12-rc2-mm3/2.6.12-rc2-mm3.bz2;patch=1 \
...
SRC_URI_append_tosa = " ${DOSRC}/tosa-machine-base-r4.patch;patch=1 \
...
CMDLINE_CON = "console=ttyS0,115200n8 noinitrd"
