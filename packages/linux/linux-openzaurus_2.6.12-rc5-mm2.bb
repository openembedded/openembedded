...
SRC_URI = "ftp://ftp.kernel.org/pub/linux/kernel/v2.6/linux-2.6.11.tar.gz \
           ftp://ftp.kernel.org/pub/linux/kernel/v2.6/testing/patch-2.6.12-rc5.bz2;patch=1 \
           ftp://ftp.kernel.org/pub/linux/kernel/people/akpm/patches/2.6/2.6.12-rc5/2.6.12-rc5-mm2/2.6.12-rc5-mm2.bz2;patch=1 \
	   ...
	   ${RPSRC}/copypagefix-r1.patch;patch=1 \
           ...
           ${RPSRC}/ipaq/hx2750_base-r15.patch;patch=1 \
...
SRC_URI_append_tosa = "${DOSRC}/nand-readid-r1.patch;patch=1 \
		       ...
		       ${DOSRC}/wm9712-ts-r1.patch;patch=1 \
