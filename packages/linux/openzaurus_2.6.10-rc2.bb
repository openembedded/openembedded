...
http://www.rpsys.net/openzaurus/${KV}/corgi_base-r4.patch;patch=1 \
http://www.rpsys.net/openzaurus/${KV}/corgi_ssp-r3.patch;patch=1 \
http://www.rpsys.net/openzaurus/${KV}/w100-r5.patch;patch=1 \
...
http://www.rpsys.net/openzaurus/${KV}/jffs2_sync-r0.patch;patch=1 \
http://www.rpsys.net/openzaurus/${KV}/corgi_kbd-r4.patch;patch=1 \
http://www.rpsys.net/openzaurus/${KV}/corgi_backlight-r3.patch;patch=1 \
http://www.rpsys.net/openzaurus/${KV}/corgi_param-r1.patch;patch=1 \
http://www.rpsys.net/openzaurus/${KV}/corgi_ts-r1.patch;patch=1 \
http://www.rpsys.net/openzaurus/${KV}/corgi_power-r0.patch;patch=1 \
...
http://www.rpsys.net/openzaurus/${KV}/pcmcia_core-r0.patch;patch=1 \
