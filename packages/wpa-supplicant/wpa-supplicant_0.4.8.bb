...
do_install () {
	...
	install -m 755 ${WORKDIR}/wpa-supplicant.sh ${D}${sysconfdir}/network/if-pre-up.d/
	cd ${D}${sysconfdir}/network/ && \
	ln -sf ../if-pre-up.d/wpa-supplicant.sh if-post-down.d/wpa-supplicant.sh && \
	ln -sf ../if-pre-up.d/wpa-supplicant.sh if-down.d/wpa-supplicant.sh
